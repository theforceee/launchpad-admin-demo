...
export const IDO_POOL_FACTORY_POLYGON_SMART_CONTRACT =
  process.env.REACT_APP_SMART_CONTRACT_POLYGON_PRESALE_FACTORY_ADDRESS || "";
...
export const MAPPING_CURRENCY_ADDRESS: any = {
  ...
  [NETWORK_AVAILABLE.POLYGON]: {
    eth: NATIVE_TOKEN_ADDRESS, // eth for native token
    native: NATIVE_TOKEN_ADDRESS,
    [ACCEPT_CURRENCY.USDT]: USDT_POLYGON_ADDRESS,
    [ACCEPT_CURRENCY.USDC]: USDC_POLYGON_ADDRESS,
  },
};
